...
hiddenValue('#7002 | Constant Contact | Free Trial | Form Messaging - Build', 'SPZ_7002_V2')
...
waitForElement('.main-grid', (targetNode) => {
    document.body.classList.add('spz_7002_v2'); // Update this class name
    console.log("Test: spz_7002_v2")
    ...
    function enhanceForm() {
        ...
        if (window.location.pathname.includes('/buynow/')) {
            ...
            if (document.querySelector('.form-headline')) {
                document.querySelector('.form-headline').innerHTML = `Get a free account`;
            }
        } else {
            ...
            if (document.querySelector('.sign-up-form-visible-legal-t-cs')) {
                ...
                if (originalText && !document.querySelector('.spz_dummy_text')) {
                    ...
                    originalText.insertAdjacentHTML('beforebegin', `<p class="spz_dummy_text">By clicking "Instant access", you agree to the <a class="spz_terms" href="javascript:void(0)">Terms of Service</a> and acknowledge receipt<br class="spz-space"/> of our <a class="spz_privacy" href="javascript:void(0)">Privacy Notice</a>.</p>`);
