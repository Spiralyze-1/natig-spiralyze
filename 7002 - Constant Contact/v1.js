...
hiddenValue('#7002 | Constant Contact | Free Trial | Form Messaging - Build', 'SPZ_7002_V1')
...
waitForElement('.main-grid', (targetNode) => {
    document.body.classList.add('spz_7002_v1'); // Update this class name
    console.log("Test: spz_7002_v1")
