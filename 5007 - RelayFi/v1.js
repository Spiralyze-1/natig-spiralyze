...
(function () {
    ...
    const variantName = expName + '-' + pageName + '-test-variant1'; //variantName should be -test-variant, -test-control etc.
        ...
        <section class="spz-before-after">
            ...
            <div class="spz-before-after-content">
                ...
                <div class="spz-before-after-second">
                    ...
                    <div>
                        <picture>
                            <source media="(min-width: 2560px)" srcset="https://res.cloudinary.com/spiralyze/image/upload/f_auto/v1773314952/relay/5007/container_3.webp">
                            <source media="(min-width: 1024px)" srcset="https://res.cloudinary.com/spiralyze/image/upload/f_auto/v1773315081/relay/5007/container_4.webp">
                            <source media="(min-width: 768px)" srcset="https://res.cloudinary.com/spiralyze/image/upload/f_auto/v1773236556/relay/5007/container_1.webp">
                            <img src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/v1773236555/relay/5007/container.webp" alt="After image" />
                        </picture>
                    </div>
                </div>
                <div class="spz-before-after-image">
                    <picture>
                        ...
                        <img src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/v1773236553/relay/5007/frame_2095584724.webp" alt="Relay circle logo" />
                    </picture>
                </div>
            </div>
        </section>    
