...
hiddenValue('#5003 | Constant Contact | Buy Now | Form Messaging - Build', 'SPZ_5003_V1')
...
function addForm() {
    ...
    if (!document.querySelector('.spz_5003_applied')) {
        ...
        document.querySelector('.form-headline').innerHTML = `Create your account`;
        document.querySelector('[type="submit"]').classList.add('spz5003_v1')
        ...
        if (formElement) {
            ...
            if (disclaimerContainer) {
                ...
                disclaimerContainer.insertAdjacentHTML('beforeend', `
		            <p class="spz_dummy_text">By clicking "Get started", you agree to the <a class="spz_terms" href="javascript:void(0)">Terms of Service</a> and acknowledge receipt<br class="spz-space"/> of our <a class="spz_privacy" href="javascript:void(0)">Privacy Notice</a>.</p>
		        `);
