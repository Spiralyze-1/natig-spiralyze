...
hiddenValue('#5002 | Constant Contact | Buy Now | Additional Fields - Build', 'SPZ_5002_V4')
/***********************************
************************************
DO NOT TOUCH
BEYOND THIS LINE
...
function addForm() {
    ...
    document.body.classList.add('spz_5002_v4');
    ...
    if (!document.querySelector('.spz_dummy_cta')) {
        ...
        async function init() {
            ...
            // Phone validation (OPTIONAL in V4)
            const validate = () => {
            ...
            // First Name validation (OPTIONAL in V4)
        ...
        (async function run() {
            try {
                ...
                if (phoneInput) {
                    ...
                    const savedPhone = sessionStorage.getItem('spz_phone_value_v4');
                    if (savedPhone) {
                        ...
                        sessionStorage.removeItem('spz_phone_value_v4');
                    }

                    // Save to sessionStorage before leaving
                    window.addEventListener('beforeunload', () => {
                        if (phoneInput.value) {
                            sessionStorage.setItem('spz_phone_value_v4', phoneInput.value);
                        }
                    });
        ...
        // Dummy cta
        document.querySelector('.spz_5002_v4 [type="submit"]').insertAdjacentHTML('afterend', `<div class="spz_dummy_cta" tabindex="0">Create my account</div>`);
        document.querySelector('.spz_dummy_cta').addEventListener('click', () => {
            ...
            // Validate First Name only if it has content (OPTIONAL)
            ...
            // Validate Phone only if it has content (OPTIONAL)
            ...
            if (canSubmit) {
                document.querySelector('.spz_5002_v4 [type="submit"]').click();
            }
            setTimeout(() => {
