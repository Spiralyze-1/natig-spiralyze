...
function resizeChanges() {
  if (window.location.href === 'https://www.awrusa.com/') {
    if (window.innerWidth >= 1024) {
        if (document.querySelector('.spz_1008_v1 [class$="__render-components"] > div')) {
            document.querySelector('.spz_1008_v1 [class$="__render-components"] > div').classList.add('awr-hero');
        }
...
function updateButtonText() {
    const btnTextEl = document.querySelector('.spz_1008_v1 form.awr-find-your-protection-plan__wrapper button span p');
...
function heroBannerMainV1() {
    if (!document.body.classList.contains('spz_1008_v1') && window.location.href === 'https://www.awrusa.com/') {
        document.body.classList.add('spz_1008_v1');
        ...
        const heroInterval = setInterval(() => {
            ...
            if (document.querySelector('.spz_1008_v1 .awr-hero')) {
...
function cardClickHandler(e) {
    if (
        e.target.matches('.spz_1008_v1 form.awr-find-your-protection-plan__wrapper button') ||
        e.target.closest('.spz_1008_v1 form.awr-find-your-protection-plan__wrapper button')
    ) {
        setTimeout(() => {
            const errorMsg = document.querySelector('.awr-find-your-protection-plan__input-error');
            if (errorMsg) {
                const formWrapper = document.querySelector('.spz_1008_v1 form.awr-find-your-protection-plan__wrapper');
                if (formWrapper) {
...
function removeTest() {
    ...
    if (document.querySelector('.spz_animated_headline')) {
        document.querySelector('.spz_animated_headline').remove();
    }
    ...
    if (document.querySelector('.spz_1008_v1 .awr-hero')) {
        document.querySelector('.spz_1008_v1 [class$="__render-components"] > div').classList.remove('awr-hero');
    }

    if (document.body.classList.contains('spz_1008_v1')) {
        document.body.classList.remove('spz_1008_v1');
    }
...
function observerForLoadingBlock() {
    ...
    const callback = function (mutationsList, observer) {
        ...
        if (pageList.includes(currentPage)) {
            ...
            console.log("Mutation detected: Run spz_1008_v1");
            heroBannerMainV1();
