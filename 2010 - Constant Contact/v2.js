...
hiddenValue('#2010 | Constant Contact | Free Trial & Buy Now | Social Proof Logos', 'SPZ_2010_V2')
            ...
            mainSection.insertAdjacentHTML('afterend', `
                <div class="spz-logo-list-wrapper">
                    ...
                    <ul class="spz-logo-list">
                        <li>
                            <img src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/constantcontact/2010/logo-cornell-engineering_webp.webp" alt="Cornel Engineering"/>
                        </li>
                        <li>
                            <img src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/constantcontact/2010/logo-techsoup_webp.webp" alt="Techsoup"/>
                        </li>
                        <li>
                            <img src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/constantcontact/2010/logo-mathnasium_webp.webp" alt="Mathnasium"/>
                        </li>
                        <li>
                            <img src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/constantcontact/2010/logo-dream-vacations_webp.webp" alt="Dream Vacations"/>
                        </li>
                        <li>
                            <img src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/constantcontact/2010/logo-kw-citywide_webp.webp" alt="KW Citywide"/>
                        </li>
                        <li>
                            <img src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/constantcontact/2010/logo-the-ups-store_webp.webp" alt="The UPS Store"/>
                        </li>
                    </ul>
                </div>
            `);
