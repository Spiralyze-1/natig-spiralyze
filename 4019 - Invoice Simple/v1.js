...
waitForElement('#tailwind', () => {
    ...
    function applyPricingCards() {
        ...
        if(isDesktop){
            ...
            if(essentialFeatureList){
                essentialFeatureList.innerHTML = `
                    ...
                    <ul class='spz-card-feature-list'>
                        <li>
                            <img src="https://res.cloudinary.com/spiralyze/image/upload/v1762537447/invoicesimple/4019/check.svg" alt="check icon">
            ...
            <button type="button" data-testid="mobile-essentials-buy-button" class="spz-buy-btn mt-8 mb-1 no-underline block w-full flex-grow rounded-[4px] border-[1px] border-solid py-3 text-center text-[14px] font-bold hover:opacity-70 bg-orange-is text-white border-orange-is">Upgrade now</button></div><div class="px-[20px] pt-[20px] rounded-b-[30px] pb-24 h-[230px]" style="border-width: 0px 2px 2px; border-style: solid; border-color: rgb(229, 231, 235); border-image: initial;">
                    <h4 class="spz-card-feature">3 invoices a month</h4>
                    <h6 class="spz-card-feature-inc">Includes:</h6>
                    <ul class="spz-card-feature-list">
                        <li>
                ...
                </div></div><div data-testid="mobile-plus-tier-card-custom" class="spz-parent-card-mobile max-w-[290px] rounded-[30px] bg-orange-50"><div class="bg-orange-200 rounded-t-[30px] py-3">
                ...
                <button type="button" data-testid="mobile-plus-buy-button" class="spz-buy-btn mt-8 mb-1 no-underline block w-full flex-grow rounded-[4px] border-[1px] border-solid py-3 text-center text-[14px] font-bold hover:opacity-70 bg-orange-is text-white border-orange-is">Upgrade now</button></div><div class="px-[20px] pt-[20px] rounded-b-[30px] pb-24 h-[230px]" style="border-width: 0px 2px 2px; border-style: solid; border-color: rgb(254, 215, 170); border-image: initial;">
                    <h4 class="spz-card-feature">10 invoices a month</h4>
                    <h6 class="spz-card-feature-inc">Everything in Essentials, and:</h6>
                    <ul class="spz-card-feature-list">
                        <li>
                ...
                </div></div><div data-testid="mobile-premium-tier-card-custom" class="spz-parent-card-mobile max-w-[290px] rounded-[30px] false"><div class="p-[20px] rounded-t-[30px]" style="border: 2px solid rgb(229, 231, 235);">
                <div class="flex items-center ">
                ...
                <button type="button" data-testid="mobile-premium-buy-button" class="spz-buy-btn mt-8 mb-1 no-underline block w-full flex-grow rounded-[4px] border-[1px] border-solid py-3 text-center text-[14px] font-bold hover:opacity-70 bg-orange-is text-white border-orange-is">Upgrade now</button></div><div class="px-[20px] pt-[20px] rounded-b-[30px] pb-24 h-[230px]" style="border-width: 0px 2px 2px; border-style: solid; border-color: rgb(229, 231, 235); border-image: initial;">
                    <h4 class="spz-card-feature">Unlimited invoices</h4>
                    <h6 class="spz-card-feature-inc">Everything in Plus, and:</h6>
                    <ul class="spz-card-feature-list">
                        <li>
