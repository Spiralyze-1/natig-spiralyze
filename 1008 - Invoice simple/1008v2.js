...
const stickyFooterContent = {
  ...
  `,
  sectionMiddleHTML: ``,
  sectionRightHTML: `<a class="spz1008_v2" href="https://www.invoicesimple.com/invoice-generator?utm_source=website&utm_medium=organic&utm_content=main_nav">Subscribe now</a>`,
};
...
function addStickyFooter(footerData) {
  ...
  const CTAbtn = document.querySelector('.spz1008_v2')
